...
until $is_config_server_on && $is_rabbitmq_on && $is_eureka_discovery_on ; do
    sleep 20
...
>&2 echo "Dependencies are up - starting ZUUL Container"
exec java -Xmx200m -jar /app/zuul-api-gateway-1.0.jar
